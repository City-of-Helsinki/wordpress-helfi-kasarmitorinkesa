...
(function ($) {
  ...
  var width = $(window).width(),
      ...
      maxWidth = 909,
      minWidth = 574,
      offset = 50; // Setup various classes which we are going to use
  ...
  var sidebar = $('#sidebar'),
      ...
      menuItems = topMenu.find('a[href*="#"]'); // This function adds position:fixed class after main hero is passed
  ...
  $(window).scroll(setNavClass); // Standard mobilemenu functionality
  ...
  $(window).scroll(function () {
    ...
    var id = cur && cur.length ? cur[0].id : ""; // Check that ID exists and adds active class
